"""
Django settings for DjangoXamarin project.
...
WSGI_APPLICATION = 'DjangoXamarin.wsgi.application'
...
GOOGLE_SCOPE = 'https://www.googleapis.com/gmail/v1/users/userId/profile'
GOOGLE_SECRET_KEY = ''
